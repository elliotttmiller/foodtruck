...
import { dollarsToCents, ingredientCostCents, buildUsageSnapshot, calculateDailyReport, unitCompatible } from '../core.js';
...
test('daily report excludes sales tax from net revenue and composes costs', () => {
  ...
  const report = calculateDailyReport({
    ...
    processingFeesCents: 7000,
    directExpensesCents: 13500,
    allocatedOverheadCents: 14000,
  });
