...
const ROUTES = new Set(['dashboard','live-orders','live-orders-demo','daily','costs','reports','settings',...Object.keys(GENERIC_MODULES)]);
function routeFromHash(){const value=location.hash.replace(/^#\/?/,'');return value==='orders'?'live-orders':ROUTES.has(value)?value:'dashboard';}
